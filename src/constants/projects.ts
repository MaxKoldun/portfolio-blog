  ...
  },
  {
    ...
    translations: {
      en: {
        ...
        description: 'Graberly provides a user with tools to collect more reviews, such as personalised QR codes and links as well as service that makes it easier to collect reviews. The project was developed by other devs but it had poor performance and many bugs. I fixed main issues and added new features like payment via Stripe.',
        technologies:
